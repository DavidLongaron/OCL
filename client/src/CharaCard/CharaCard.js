    ...
    return(
        ...
        <Link to={`/chara/${props.chara.id}`}> 
         ...
         <div className="chara-content">
             <button onClick={()=>{ setFavorited(!favorited)}} ><svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${favorited?"text-green-600":"text-gray-400"} `} viewBox="0 0 20 20" fill="currentColor">
