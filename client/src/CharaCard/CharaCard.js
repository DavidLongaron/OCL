        ...
        <div onClick={changeCharaHandler} className="flex mt-14 mx-5 h-48 w-96 border-2 box-border rounded bg-white">
            ...
            <div className="chara-content w-1/2">
                <div className="  w-full flex  flex-row-reverse mr-12 mt-2">
                    <button className="mr-4" onClick={() => { setFavorited(!favorited); handleFavorites(); }} ><svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${favorited ? "text-green-600" : "text-gray-400"} `} viewBox="0 0 20 20" fill="currentColor">
